...
pub enum ErrorCode {
    ...
    ChannelAlreadyExists = 40009,
    NotChannelParticipant = 40010,
...
impl ErrorCode {
    pub fn message(&self) -> &str {
        match self {
            ...
            ErrorCode::ChannelAlreadyExists => "Channel already exists",
            ErrorCode::NotChannelParticipant => "Not a channel participant",
