...
impl ApiErrorImpl for ImageError {
    fn get_codes(&self) -> (StatusCode, ErrorCode) {
        match self {
            ...
            ImageError::DeleteError => (StatusCode::INTERNAL_SERVER_ERROR, ErrorCode::Default),
            ...
            ImageError::DatabaseError(_) => (StatusCode::INTERNAL_SERVER_ERROR, ErrorCode::Default),
        }
    }
}
